...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionado(){
        ...
        System.out.println("Imprimido lista de de candidatos selecionados: ");
    ...
    static void analisarCandidato(double salarioPretendido) {
        ...
        if (salarioBase > salarioPretendido) {
            ...
            System.out.println("AGUARANDAO O RESULTADO DOS DEMAIS CANDIDATOS");
        }
    ...
    static void entrandoEmContato(String candidato)
    {
        ...
        System.out.println("Não conseguimos contato com o candidato " + candidato + " , numeros de tentativas feitas: " + tentativasRealizadas );
    }
